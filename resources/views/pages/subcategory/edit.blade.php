...
@section('title', 'Modifier une sous catégorie - ' . config('app.name'))
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('update.subcategory', $subcategory->id) }}">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Category French</label>
                        <input type="text" class="form-control" name="subcategory_fr"
                            value="{{ $subcategory->subcategory_fr }}">
