...
@section('title', 'Nouvelle sous catégorie - ' . config('app.name'))
                      ...
                      <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                          <span>
                              <a href="{{ url('/') }}" target="_blank"
                                  class="btn btn-outline-light btn-rounded get-started-btn">Visit
                                  Frontend ?</a>
                          </span>
                      </div>
                  </div>
      ...
      <div class="card">
          <div class="card-body">
              ...
              <form class="forms-sample" method="POST" action="{{ route('store.subcategory') }}">
                  ...
                  <div class="form-group">
                      <label for="exampleInputEmail1">SubCategory French</label>
                      <input type="text" class="form-control" name="subcategory_fr" placeholder="SubCategory French">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" name="category_id" id="exampleFormControlSelect2">
                          ...
                          @foreach ($category as $row)
                              <option value="{{ $row->id }}">{{ $row->category_en }} | {{ $row->category_fr }}
                              </option>
                          @endforeach
                      </select>
                  </div>
