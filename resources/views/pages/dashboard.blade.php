...
@section('title', 'Tableau de board - ' . config('app.name'))
...
@section('content')
                ...
                <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-5 col-sm-7 col-xl-8 p-0">
                            <h4 class="mb-1 mb-sm-0">Bienvenue sur le tableau de bord Invest & Partners</h4>
                            <p class="mb-0 font-weight-normal d-none d-sm-block">Votre plateforme de mise en relation de porteurs de projets et investisseurs.</p>
                        </div>
                        <div class="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                            <span>
                                <a href="{{ url('/') }}" target="_blank" class="btn btn-outline-light btn-rounded get-started-btn">Allez sur le site</a>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Croissance du mois</h6>
                </div>
            </div>
        </div>
        --}}
        <div class="col-xl-6 col-sm-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Revenu du jour</h6>
                </div>
            </div>
        </div>
        <div class="col-xl-6 col-sm-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="text-muted font-weight-normal">Revenu du mois</h6>
                </div>
            </div>
        </div>
        {{--
        ...
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Historique de transactions</h4>
                    {{-- <canvas id="transaction-history" class="transaction-chart chartjs-render-monitor" style="display: block; width: 466px; height: 233px;" width="466" height="233"></canvas> --}}
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                        <div class="text-md-center text-xl-left">
                            <h6 class="mb-1">Transferts par OM</h6>
                            <p class="text-muted mb-0">09 Sept 2021, 09:12AM</p>
                        </div>
                        <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                            <h6 class="font-weight-bold mb-0">50 000 FCFA</h6>
                        </div>
                    </div>
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                        <div class="text-md-center text-xl-left">
                            <h6 class="mb-1">Transferts par MOMO</h6>
                            <p class="text-muted mb-0">09 Sept 2021, 09:12AM</p>
                        </div>
                        <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                            <h6 class="font-weight-bold mb-0">30 000 FCFA</h6>
                        </div>
                    </div>
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                        <div class="text-md-center text-xl-left">
                            <h6 class="mb-1">Transferts par Carte bancaire</h6>
                            <p class="text-muted mb-0">09 Sept 2021, 09:12AM</p>
                        </div>
                        <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                            <h6 class="font-weight-bold mb-0">160 000 FCFA</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row justify-content-between">
                        <h4 class="card-title mb-1">Projets consultés</h4>
                        <p class="text-muted mb-1">Statut des données</p>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="preview-list">
                                <div class="preview-item border-bottom">
                                    ...
                                    <div class="preview-item-content d-sm-flex flex-grow">
                                        <div class="flex-grow">
                                            <h6 class="preview-subject">Conception d'un tissu non salissant</h6>
                                            <p class="text-muted mb-0">Textile</p>
                                        </div>
                                        <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                            <p class="text-muted">Il y a 15 minutes</p>
                                            {{--
                                ...
                                <div class="preview-item border-bottom">
                                    ...
                                    <div class="preview-item-content d-sm-flex flex-grow">
                                        <div class="flex-grow">
                                            <h6 class="preview-subject">Transformation du cacao</h6>
                                            <p class="text-muted mb-0">Agro-Industrie</p>
                                        </div>
                                        <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                            <p class="text-muted">Il y a 1 heure</p>
                                            {{--
                                ...
                                <div class="preview-item border-bottom">
                                    ...
                                    <div class="preview-item-content d-sm-flex flex-grow">
                                        <div class="flex-grow">
                                            <h6 class="preview-subject">Construction d'un hotel 5 étoiles</h6>
                                            <p class="text-muted mb-0">Immobilier</p>
                                        </div>
                                        <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                ...
                                <div class="preview-item border-bottom">
                                    ...
                                    <div class="preview-item-content d-sm-flex flex-grow">
                                        <div class="flex-grow">
                                            <h6 class="preview-subject">Développement d'un</h6>
                                            <p class="text-muted mb-0">Forets et Bois</p>
                                        </div>
                                        <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                            <p class="text-muted">Il y a 55 minutes</p>
                                            {{--
                                ...
                                <div class="preview-item">
                                    ...
                                    <div class="preview-item-content d-sm-flex flex-grow">
                                        <div class="flex-grow">
                                            <h6 class="preview-subject">Energie éolienne</h6>
                                            <p class="text-muted mb-0">Industrie de l'énergie</p>
                                        </div>
                                        <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                            <p class="text-muted">Il y a 50 minutes</p>
                                            {{--
    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Statut des paiements</h4>
    ...
    <div class="row">
                        ...
                        <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-flex flex-grow">
                                <div class="flex-grow">
                                    ...
                                    <p class="text-muted">RDV à 15 heures.</p>
                                </div>
                            </div>
                        </div>
                        <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-flex flex-grow">
                                <div class="flex-grow">
                                    ...
                                    <p class="text-muted">Bien, ca a l'air de fonctionner.</p>
                                </div>
                            </div>
                        </div>
                        <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-flex flex-grow">
                                <div class="flex-grow">
                                    <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                        ...
                                        <p class="text-muted text-small">Il y a 2 heures</p>
                                    </div>
                                    <p class="text-muted">Revoyez la description svp.</p>
                                </div>
                            </div>
                        </div>
                        <div class="preview-item border-bottom">
                            ...
                            <div class="preview-item-content d-flex flex-grow">
                                <div class="flex-grow">
                                    <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                        ...
                                        <p class="text-muted text-small">Il y a 4 heures</p>
                                    </div>
                                    <p class="text-muted">Merci beaucoup.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-6 col-xl-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Evènement du jour</h4>
                    <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel owl-loaded owl-drag" id="owl-carousel-basic">
                        <div class="owl-stage-outer">
                            <div class="owl-stage" style="transform: translate3d(-1428px, 0px, 0px); transition: all 0.25s ease 0s; width: 3335px;">
                                <div class="owl-item cloned" style="width: 466.328px; margin-right: 10px;">
                                    <div class="item">
                                ...
                                <div class="owl-item" style="width: 466.328px; margin-right: 10px;">
                                    <div class="item">
                                        <img src="assets/images/dashboard/Rectangle.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="owl-item active" style="width: 466.328px; margin-right: 10px;">
                                    <div class="item">
                                        <img src="assets/images/dashboard/Img_5.jpg" alt="" />
                                    </div>
                                </div>
                        ...
                        <div class="owl-nav">
                            <button type="button" role="presentation" class="owl-prev"><i class="mdi mdi-chevron-left"></i></button><button type="button" role="presentation" class="owl-next"><i class="mdi mdi-chevron-right"></i></button>
                        </div>
                        ...
                        <div class="preview-list w-100">
                            <div class="preview-item p-0">
                                ...
                                <div class="preview-item-content d-flex flex-grow">
                                    <div class="flex-grow">
                                        <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                            <h6 class="preview-subject">WorkShop</h6>
                                            <p class="text-muted text-small">12 Sept 2021</p>
                                        </div>
                                        <p class="text-muted">17h30 - 21h.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <p class="text-muted">Hotel la Falaise, Bonanjo.</p>
        ...
        <div class="col-md-12 col-xl-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Liste à faire</h4>
                    <div class="add-items d-flex">
                        <input type="text" class="form-control todo-list-input" placeholder="entrer la tache.." />
                        ...
                        <ul class="d-flex flex-column-reverse text-white todo-list todo-list-custom">
                            <li>
                                <div class="form-check form-check-primary">
                                    <label class="form-check-label"> <input class="checkbox" type="checkbox" /> Créer Facture<i class="input-helper"></i></label>
                                </div>
                                <i class="remove mdi mdi-close-box"></i>
                            </li>
                            <li>
                                <div class="form-check form-check-primary">
                                    <label class="form-check-label"> <input class="checkbox" type="checkbox" /> RDV avec HI <i class="input-helper"></i></label>
                                </div>
                                <i class="remove mdi mdi-close-box"></i>
                            </li>
                            <li class="completed">
                                <div class="form-check form-check-primary">
                                    <label class="form-check-label">
                                        ...
                                        Preparation pour presentation <i class="input-helper"></i>
                                    </label>
                                </div>
                                <i class="remove mdi mdi-close-box"></i>
                            </li>
                            <li>
                                <div class="form-check form-check-primary">
                                    <label class="form-check-label"> <input class="checkbox" type="checkbox" /> Ajouter des catégories <i class="input-helper"></i></label>
                                </div>
                                <i class="remove mdi mdi-close-box"></i>
                            </li>
                            <li>
                                <div class="form-check form-check-primary">
                                    <label class="form-check-label"> <input class="checkbox" type="checkbox" /> Réunion avec les conseillers <i class="input-helper"></i></label>
                                </div>
                                <i class="remove mdi mdi-close-box"></i>
                            </li>
                        </ul>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Visiteurs par Pays</h4>
                    <div class="row">
                        <div class="col-md-5">
                            <div class="table-responsive">
                                <table class="table">
                        ...
                        <div class="col-md-7">
                            <div id="audience-map" class="vector-map">
                                <div class="jvectormap-container" style="background-color: transparent;">
                                    <svg width="894.734" height="300">
                                        <defs></defs>
                                        <g transform="scale(0.6807254461445078) translate(207.19153372890176, 0)">
                                            <path
