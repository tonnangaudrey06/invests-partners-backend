              ...
              <form id="profilInvestisseurForm" action="{{ route('investissement.store') }}" method="POST"
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="invest-date" placeholder="Date de versement"
                      name="date_versement" data-date-format="dd/mm/yyyy" data-date-autoclose="true"
                      data-date-end-date="0d" autocomplete="off" required value="{{ old("") }}">
                  ...
                  <div class="form-group col-md-12 mb-3">
                    ...
                    <select class="form-control" name="investisseur" required>
                      ...
                      @foreach ($investisseurs as $investisseur)
                        <option @if(old("investisseur") == $investisseur->id) selected @endif value="{{ $investisseur->id }}">{{ $investisseur->nom }}
                  ...
                  <div class="form-group col-md-12 mb-3">
                    ...
                    <select class="form-control" name="projet" required>
                      ...
                      @foreach  ($projets as $projet)
                        <option @if(old("projet") == $projet->id) selected @endif value="{{ $projet->id }}">{{ $projet->intitule }}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group col-md-12 mb-3">
                    ...
                    <input type="number" class="form-control" name="montant_investi" placeholder="0 XAF" required value="{{ old("montant_investi") }}">
