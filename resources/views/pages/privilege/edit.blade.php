            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.writer', [$writer->role, $writer->module]) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" name="role">
                                    ...
                                    <option value="{{ $item->id }}" <?php if($item->id == $writer->role){
                                        echo "selected";
                                    } ?>>{{ $item->libelle}}</option>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" name="module">
                                    ...
                                    <option value="{{ $item->id }}" <?php if($item->id == $writer->module){
                                        echo "selected";
                                    } ?>>{{ $item->module}}</option>
                                    @endforeach
                                </select>
                                ...
                                <div class="w-50 mx-auto">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="consulter" id="consulter"
                                            value="1" <?php if($writer->consulter == 1){
                                                echo "checked";
                                            } ?>>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="modifier" id="modifier"
                                            value="1" <?php if($writer->modifier == 1){
                                                echo "checked";
                                            } ?>>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="ajouter" id="ajouter"
                                            value="1" <?php if($writer->ajouter == 1){
                                                echo "checked";
                                            } ?>>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="supprimer" id="supprimer"
                                            value="1" <?php if($writer->supprimer == 1){
                                                echo "checked";
                                            } ?>>
