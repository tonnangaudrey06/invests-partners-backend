...
@section('title', 'Modifier une catégorie - ' . config('app.name'))
...
@section('content')
  ...
  <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
          <div class="card-body">
              <h4 class="card-title">Mettre à jour Categorie</h4>

              <form class="forms-sample" method="POST" action="{{ route('update.category', $category->id) }}">
                  @csrf
                  <div class="form-group">
                      <label for="exampleInputUsername1">Categorie Anglais</label>
                  ...
                  <div class="form-group">
                      <label for="exampleInputEmail1">Categorie Francais</label>
