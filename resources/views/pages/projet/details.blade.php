      ...
      <div class="d-flex justify-content-between align-items-center">
       ...
       <div class="actions d-flex align-items-center">
         ...
         @if ($privilege->module == 1 && $privilege->modifier == 1)
          @if (auth()->user()->role == 1)
           @if ($projet->etat == 'ATTENTE_VALIDATION_ADMIN' || $projet->etat == 'ATTENTE_INFO_SUPPL')
            <a href="{{ route('projet.admin.validate', $projet->id) }}" class="btn btn-sm btn-success me-2">Approuver</a>
            <a href="{{ route('projet.askinfosupp', $projet->id) }}" class="btn btn-sm btn-info me-2">Demander info
             supple</a>
          ...
          @else
           @if ($projet->etat == 'ATTENTE' || $projet->etat == 'ATTENTE_INFO_SUPPL')
            <a href="{{ route('projet.civalidate', $projet->id) }}" class="btn btn-sm btn-success me-2">Approuver</a>
            <a href="{{ route('projet.askinfosupp', $projet->id) }}" class="btn btn-sm btn-info me-2">Demander info
             supp</a>
            <a href="{{ route('projet.rejet', $projet->id) }}" class="btn btn-sm btn-dark me-2">Rejeter</a>
           @endif
        ...
        @if ($projet->etat == 'VALIDE' || $projet->etat == 'COMPLET' || $projet->etat == 'PUBLIE')
         <a href="{{ route('projet.edit', $projet->id) }}" class="btn btn-sm btn-warning me-2">Modifier</a>
        @endif
        ...
        @foreach ($privileges as $privilege)
         @if ($privilege->module == 1 && $privilege->supprimer == 1)
          <a href="{{ route('projet.delete', $projet->id) }}"
           onclick="return confirm('Voulez-vous vraiment supprimer?')" class="btn btn-sm btn-danger me-2">Supprimer</a>
         @endif
        @endforeach
         ...
         <div class="card-body">
          <div class="d-flex mb-5">
           <div class="flex-shrink-0 me-4">
            <img src="{{ $projet->logo ? $projet->logo : asset('assets/images/projet.jpg') }}" alt=""
             class="avatar-md">
           </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
             <div class="d-flex justify-content-start align-items-center">
              <div class="event-timeline-dot align-self-center">
               <i class="bx bxs-right-arrow-circle font-size-18 text-primary"></i>
              </div>
          ...
          <div class="text-muted mb-4">
           <strong>
            <p>
             ...
             <span class="text-primary fw-bolder">{{ number_format($total_invest, 0, ',', ' ') }}
              XAF</span>
            </p>
            <p>
             <i class="mdi mdi-chevron-right text-primary me-1"></i>
               ...
               <tr>
                <td>
                 <a target="_blank" href="{{ $item->photo }}">
                  <img src="{{ $item->photo }}" class="rounded-circle avatar-xs" alt="">
                 </a>
                </td>
                <td>
                 <h5 class="font-size-14 m-0">
                  <a href="javascript: void(0);" class="text-dark">{{ $item->nom_complet }}</a>
                 </h5>
                 <span class="badge bg-primary bg-soft text-primary font-size-11">{{ $item->pivot->statut }}</span>
                </td>
                <td>
                 {{ $item->telephone }}
                </td>
            ...
            <tbody>
             @foreach ($docs as $row)
              <tr>
               ...
               <td>
                <h5 class="font-size-12 text-truncated-2 mb-0"><a target="_blank" download
                  href="{{ $row->document }}" class="text-dark">{{ $row->type }}</a></h5>
               </td>
               <td style="width: 10%;">
          ...
          <table class="table align-middle table-hover mb-0">
           <tbody>
            <tr>
             ...
             <td>
              <h5 class="font-size-12 text-truncated-2 mb-0"><a download target="_blank"
                href="{{ $projet->doc_presentation }}" class="text-dark">Presentation du projet</a></h5>
             </td>
             <td style="width: 10%;">
              <div class="text-center">
               <a download target="_blank" href="{{ $projet->doc_presentation }}" class="text-dark"><i
                 class="bx bx-download h4 m-0"></i></a>
              </div>
             </td>
            </tr>
          ...
          <div class="accordion" id="accordionExamplePP">
           <div class="accordion-item">
            <h2 class="accordion-header" id="headingOnePP">
             <button class="accordion-button fw-bolder collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapseOnePP" aria-expanded="false" aria-controls="collapseOnePP">
              Documents
             </button>
            </h2>
            <div id="collapseOnePP" class="accordion-collapse collapse" aria-labelledby="headingOnePP"
             data-bs-parent="#accordionExamplePP">
                ...
                @foreach ($filesPP as $row)
                 @if ($row->type == 'FICHIER')
                  <tr>
                   ...
                   <td>
                    <h5 class="font-size-12 text-truncated-2 mb-0">
                   ...
                   <td style="width: 20%;">
                    <div class="text-center">
                     <a href="{{ route('archive.delete.projet', $row->id) }}">
                      <i class="bx bx-trash h4 m-0 me-2 text-danger"></i>
                     </a>
                     <a download target="_blank" href="{{ $row->url }}" class="text-dark">
                      <i class="bx bx-download h4 m-0"></i>
                     </a>
                    </div>
                   </td>
                  </tr>
           ...
           <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwoPP">
             <button class="accordion-button fw-bolder collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapseTwoPP" aria-expanded="false" aria-controls="collapseTwoPP">
              Images
             </button>
            </h2>
            <div id="collapseTwoPP" class="accordion-collapse collapse" aria-labelledby="headingTwoPP"
             data-bs-parent="#accordionExamplePP">
             <div class="accordion-body">
              <table class="table align-middle table-hover mb-0">
               <tbody>
           ...
           <div class="accordion-item">
            <h2 class="accordion-header" id="headingThreePP">
             <button class="accordion-button fw-bolder collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapseThreePP" aria-expanded="false" aria-controls="collapseThreePP">
              Vidéos
             </button>
            </h2>
            <div id="collapseThreePP" class="accordion-collapse collapse" aria-labelledby="headingThreePP"
             data-bs-parent="#accordionExamplePP">
             <div class="accordion-body">
              <table class="table align-middle table-hover mb-0">
               <tbody>
          ...
          <div class="accordion" id="accordionExampleIV">
           <div class="accordion-item">
            <h2 class="accordion-header" id="headingOneIV">
             <button class="accordion-button fw-bolder collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapseOneIV" aria-expanded="false" aria-controls="collapseOneIV">
              Documents
             </button>
            </h2>
            <div id="collapseOneIV" class="accordion-collapse collapse" aria-labelledby="headingOneIV"
             data-bs-parent="#accordionExampleIV">
             <div class="accordion-body">
              <table class="table align-middle table-hover mb-0">
               <tbody>
           ...
           <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwoIV">
             <button class="accordion-button fw-bolder collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapseTwoIV" aria-expanded="false" aria-controls="collapseTwoIV">
              Images
             </button>
            </h2>
            <div id="collapseTwoIV" class="accordion-collapse collapse" aria-labelledby="headingTwoIV"
             data-bs-parent="#accordionExampleIV">
             <div class="accordion-body">
              <table class="table align-middle table-hover mb-0">
               <tbody>
           ...
           <div class="accordion-item">
            <h2 class="accordion-header" id="headingThreeIV">
             <button class="accordion-button fw-bolder collapsed" type="button" data-bs-toggle="collapse"
              data-bs-target="#collapseThreeIV" aria-expanded="false" aria-controls="collapseThreeIV">
              Vidéos
             </button>
            </h2>
            <div id="collapseThreeIV" class="accordion-collapse collapse" aria-labelledby="headingThreeIV"
             data-bs-parent="#accordionExampleIV">
             <div class="accordion-body">
              <table class="table align-middle table-hover mb-0">
               <tbody>
