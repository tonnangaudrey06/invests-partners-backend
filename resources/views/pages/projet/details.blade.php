                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    <h5 class="text-truncate font-size-15">{{$projet->intitule}}</h5>
                                    <p class=" text-primary">{{$projet->financement}} FCFA</p>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width: 50px;"><img src="{{asset($item->photo)}}"
                                                    class="rounded-circle avatar-xs" alt=""></td>
                                            <td>
                                                <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                                        class="text-dark">{{$item->nom}}</a></h5>
                                            </td>
                                            <td>
                                                <div>
                                                    <a href="javascript: void(0);"
                                                        class="badge bg-primary bg-soft text-primary font-size-11">{{$item->pivot->statut}}</a>
                                ...
                                <table class="table table-nowrap align-middle table-hover mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="font-size-14 mb-1"><a href="{{asset($projet->doc_presentation)}}"
                                                        class="text-dark">Document de présentation</a></h5>
                                                <small>Important</small>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <a href="{{asset($projet->doc_presentation)}}" class="text-dark" target="blank"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    <a href="{{asset($row->url)}}" class="text-dark" target="blank"><i
                                                            class="bx bx-download h3 m-0"></i></a>
                                                </div>
                                            </td>
                                        </tr>
