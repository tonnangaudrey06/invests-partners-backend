                            ...
                            <div class="card-body">
                                ...
                                <form
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="objet" name="objet" type="text" class="form-control" value="Demande d’informations complémentaires de votre projet '{{ $projet->intitule }}'">
...
@if (auth()->user()->role == 2)
Cher {{ $projet->user_data->nom_complet }},
<br>
