                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ (Auth()->user()->role == 1) ? route('projet.admin.infosupp', $projet->id) : route('projet.ci.infosupp', $projet->id)  }}" method="POST"
                                >
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea class="form-control" id="message" name="message" rows="3" placeholder="Entrer votre message"></textarea>
