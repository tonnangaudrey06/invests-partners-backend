                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('projet.store') }}" method="POST"
                                ...
                                <div class="row mb-4">
                                        ...
                                        <label for="exampleInputName1" class="col-form-label col-lg-2">Secteur d'activité</label>
                                        <div class="col-lg-10">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <label for="exampleInputName1" class="col-form-label col-lg-2">Etat d'avancement</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="row mb-4">
                                    <label for="projectbudget" class="col-form-label col-lg-2">Besoin en
                                        financement</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="ville_activite" name="ville_activite" type="text"
                                            class="form-control" placeholder="Entrez la ville">
                                ...
                                <div class="row mb-4">
                                    <label for="duree" class="col-form-label col-lg-2">Durée du projet (en mois)
                                        </label>
                                    <div class="col-lg-10">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <input type="file" name="medias[]" class="form-control" id="exampleInputEmail1"
