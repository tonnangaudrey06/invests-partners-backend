                    ...
                    <div class=" form-group">
                        ...
                        <div class="row">
                            <label class="form-check-label col-md-3">
                                <input type="checkbox" class="form-check-input" value="1" name="headline" <?php if($post->headline == 1){
                                echo "checked";
                            }   ?>> Headline <i class="input-helper"></i></label>

                            <label class="form-check-label col-md-3">
                                <input type="checkbox" class="form-check-input" value="1" name="bigthumbnail" <?php if($post->bigthumbnail == 1){
                                echo "checked";
                            }   ?>> General Big
                                Thumbnail
                            ...
                            <label class="form-check-label col-md-3">
                                <input type="checkbox" class="form-check-input" value="1" name="first_section" <?php if($post->first_section == 1){
                                echo "checked";
                            }   ?>> First
                                Section <i class="input-helper"></i></label>

                            <label class="form-check-label col-md-3">
                                <input type="checkbox" class="form-check-input" value="1" name="first_section_thumbnail" <?php if($post->first_section_thumbnail == 1){
                                echo "checked";
                            }   ?>>
                                First
