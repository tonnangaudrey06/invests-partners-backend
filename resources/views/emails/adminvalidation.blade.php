...
<body>
  <p> Félicitations ! Votre projet <strong>{{$projet['user_data']['nom_complet']}}</strong> a retenu l'attention de
    ...
    Aussi pour nous permettre de travailler à la recherche d'investisseurs grâce à votre visibilité sur la plateforme,
    cliquez sur ce lien (<strong><a href="https://invest--partners.com/dashboard/projets/{{$projet['id'] }}">
        https://invest--partners.com/dashboard/projets/{{$projet['id']}} </a></strong>) et validez le paiement des frais
    d'étude et de publication de votre projet et commencez
