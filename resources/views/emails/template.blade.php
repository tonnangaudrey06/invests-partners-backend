...
<body style="word-spacing:normal;background-color:#E7E7E7;">
    ...
    <div style="background-color:#E7E7E7;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            style="background:#C5473B;background-color:#C5473B;width:100%;">
            <tbody>
                <tr>
                    <td>
                        <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" bgcolor="#C5473B" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="width:100px;">
                                                                                <img height="auto"
                                                                                    src="https://admin.invest--partners.com/assets/images/logo-dark.png"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:14px;font-weight:normal;line-height:24px;text-align:left;color:#212b35;">
                                                                        @yield('content')
                                                                    </div>
                                                                </td>
                                                            </tr>
