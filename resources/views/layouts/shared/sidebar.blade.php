<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
            ...
            <div class="profile-desc">
                <div class="profile-pic">
                    ...
                    <div class="profile-name">
                        <h5 class="mb-0 font-weight-normal">{{ Auth::user()->name ?? 'Guest' }}</h5>
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link"
                            href="#">Slider</a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="#">Partenaires</a></li>
                </ul>
            </div>
        </li>

        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('category.general.view') }}">
                <span class="menu-icon">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-projet" aria-expanded="false"
                aria-controls="ui-projet">
                <span class="menu-icon">
