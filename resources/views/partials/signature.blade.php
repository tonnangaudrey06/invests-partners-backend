    ...
    <div class="row">
        <div class="col-md-4 col-sm-12 d-flex align-items-center flex-column" style="margin: 0 3rem">
            ...
            <div class="d-flex justify-content-center">
                ...
                <a href="https://invest--partners.com" class="text-decoration-none me-2 icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
                        <path
        ...
        <div class="col-md-8 col-sm-12">
            ...
            <div>
                ...
                <p class="text-muted d-flex align-items-center">
                    <span class="me-2 icon-sm">
                        <svg width="18" height="18" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
                    ...
                    <span>https://www.ip-investmentsa.com</span>
                </p>
                <p class="text-muted d-flex align-items-center">
                    <span class="me-2 icon-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                    ...
                    <span>Douala, Akwa Rue BEBEY ELAME</span>
                </p>
            </div>
        </div>
    </div>
